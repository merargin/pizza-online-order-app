...
const Review = ({ prevClick, form }) => {

  const selected = form.ingredients.length > 0 ? form.ingredients.join(', ') : 'None specified';
  ...
  return (
    ...
    <main>
      ...
      <div className="paper-white container-relative">
        ...
        <button onClick={prevClick} className="pure-button button-previous">

          <img className="icon-left" src="../../src/assets/icons/back_arrow.png" />
